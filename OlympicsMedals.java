package com.cybertek.OlympicsMedals;
...
public class OlympicsMedals {
	...
	//===========checking if the Country names are not ascending order by default======
	List<String> actual=new ArrayList<String>();
	List<String> expected=new ArrayList<String>();
	List<WebElement> countryName=driver.findElements(By.xpath("//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']//tbody/tr/th/a"));
	...
	//===========checking if the Country names are ascending order after clicking NOC======
	...
	//===========Getting the Countries with 18 Silver Medals======
		...
		List<WebElement> silverCount=driver.findElements(By.xpath("//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']//tbody//td[3]"));
	...
	public void testJapan()   {
		...
		List<WebElement> countries = driver.findElements(By.xpath("//table[@class = 'wikitable sortable"
				+ " plainrowheaders jquery-tablesorter']//tbody//th"));
		int row = 0;
		...
		List<WebElement> columns = driver.findElements(By.xpath("//table[@class = 'wikitable sortable"
				+ " plainrowheaders jquery-tablesorter']//thead//th"));
